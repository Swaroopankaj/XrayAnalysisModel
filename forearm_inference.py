...
if __name__ == "__main__":
    ...
    possible_dataset_paths = [
        ...
        os.path.join(os.path.dirname(__file__), 'D:\Git_Workspace\Python\ForearmXrayAnalysisModel\TrainingData'), # Relative to script
    ...
    def is_valid_dataset_path(path):
        ...
        return (os.path.exists(os.path.join(path, 'test', 'normal')) and
                os.path.exists(os.path.join(path, 'test', 'abnormal')) and
                len(os.listdir(os.path.join(path, 'test', 'normal'))) > 0)
        ...
        if is_valid_dataset_path(current_dir):
            ...
            while YOUR_PROCESSED_DATASET_PATH is None:
                ...
                if is_valid_dataset_path(user_input_path):
                    ...
                    print("Invalid path or dataset structure not found. Please try again.")
